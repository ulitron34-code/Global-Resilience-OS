const SCHEMAS = [
  { id: 'event-envelope', version: '1.0.0', status: 'local', required: ['externalId', 'sourceId', 'eventType', 'title', 'severity', 'impactUsd'], enums: { severity: ['critical', 'high', 'medium', 'low'] }, provenanceRequiredInProduction: true, notes: 'Validated by validateEventEnvelope; unknown provider fields belong in payload.' },
