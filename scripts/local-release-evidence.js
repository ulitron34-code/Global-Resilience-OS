...
const checks = [
  ...
  { id: 'frontend-build', command: process.platform === 'win32' ? (process.env.ComSpec || 'cmd.exe') : npm, args: process.platform === 'win32' ? ['/d', '/s', '/c', 'npm.cmd run build'] : ['run', 'build'], cwd: 'frontend' },
