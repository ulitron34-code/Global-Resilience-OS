...
const phases = {
  ...
  'phase-7': ['backend/domain/capacityMarketplace.js', 'backend/domain/modelProfiles.js', 'backend/domain/valueCase.js', 'docs/ROADMAP.md', 'docs/REGULATORY_EVIDENCE.md', 'docs/LOCAL_CAPABILITY_MATRIX.md'],
};
