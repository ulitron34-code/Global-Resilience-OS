...
const labels = { implemented_local: 'IMPLEMENTADO', configured_local: 'CONFIGURADO', demo_optional: 'DEMO OPCIONAL', partial_local: 'PARCIAL', pending_external: 'PENDING EXTERNO', illustrative_only: 'ILUSTRATIVO' };
