...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-void flex flex-col">
      ...
      <footer className="border-t border-line py-4"><div className="max-w-[1600px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-2 text-[11px] text-ink-dim font-mono"><span>GLOBAL RESILIENCE OS · Systemic Monitoring for Critical Infrastructure</span><span>Flow and route data: real-time AIS, Kpler, and TeleGeography feeds.</span></div></footer>
    </div>
  );
}
