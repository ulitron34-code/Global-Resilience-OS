...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-void flex flex-col">
      ...
      <footer className="border-t border-line py-4"><div className="max-w-[1600px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-2 text-[11px] text-ink-dim font-mono"><span>GLOBAL RESILIENCE OS · Monitoreo Sistémico de Infraestructura Crítica</span><span>Datos de flujo y rutas: Feeds en tiempo real AIS, Kpler y Telegeography.</span></div></footer>
    </div>
  );
}
