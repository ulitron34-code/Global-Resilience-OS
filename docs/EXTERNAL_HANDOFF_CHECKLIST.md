...
- GitHub: el repositorio remoto sigue en `8a0cfc2`; el checkout local contiene el índice de resiliencia, onboarding de fuentes, aislamiento tenant y release gate listos; falta publicar los commits locales.
