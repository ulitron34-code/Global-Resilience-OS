...
- GitHub: el repositorio remoto sigue en `8a0cfc2`; el checkout local está en `ebd0e46` con el bloque de intake, aislamiento tenant y release gate listos; falta publicar los commits locales.
